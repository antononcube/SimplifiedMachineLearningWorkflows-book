...
By executing those translations we interpret commands of the spoken DSL into ML computational results.
...
For each type of workflow is developed a specilized parser-interpreter [Raku](https://raku.org) module.

Each Raku module:

1. Parses a sequence of natural commands of a certain DSL

2. Interprets the parsing results into corresponding software monad code

Different programming languages and packages can be the targets of the code generation.

(At this point are implemented parser-interpreters to Python, R, and Wolfram Language.)
